...
export function RepoCard({
  ...
  return (
    <motion.button
      ...
      className={cn(
        'group w-full rounded-fw-card border border-border bg-panel p-4 text-left',
        ...
        selected &&
          'border-l-[3px] border-l-fw-orange bg-fw-orange-light/40 ring-1 ring-fw-orange-mid',
      )}
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-xs text-muted-foreground">{repo.summary}</p>
