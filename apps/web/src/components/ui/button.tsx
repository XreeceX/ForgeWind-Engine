...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    'border border-transparent bg-gradient-to-r from-fw-orange to-amber-500 text-white shadow-sm hover:shadow-md hover:brightness-105 active:scale-[0.98]',
  secondary: 'border border-border bg-panel text-foreground shadow-sm hover:bg-surface-light',
  ghost: 'border border-transparent bg-transparent text-muted-foreground hover:text-fw-orange',
  danger:
