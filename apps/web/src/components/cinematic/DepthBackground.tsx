...
export function DepthBackground({ className }: DepthBackgroundProps) {
  ...
  return (
    ...
    >
      ...
      />
      <ParallaxLayer depth={0.5} className="absolute -left-16 top-[8%] h-80 w-80 rounded-full bg-primary-400/20 blur-[110px]" />
      <ParallaxLayer depth={0.35} className="absolute right-[-10%] top-[28%] h-72 w-72 rounded-full bg-accent-300/25 blur-[105px]" />
      <ParallaxLayer depth={0.2} className="absolute bottom-[-8%] left-[25%] h-96 w-96 rounded-full bg-white/70 blur-[120px]" />
