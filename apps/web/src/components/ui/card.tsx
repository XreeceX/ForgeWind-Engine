...
const variantStyles: Record<CardVariant, string> = {
  ...
  glass:
    'rounded-fw-card border border-white/30 bg-white/70 shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-white/5',
};
...
export function Card({
  ...
  return (
    <div className={cn(variantStyles[resolvedVariant], className)} {...props}>
      {children}
    </div>
  );
}
