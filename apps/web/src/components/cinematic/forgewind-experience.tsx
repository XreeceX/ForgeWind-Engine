    ...
    <div ref={containerRef} className="relative min-h-screen overflow-x-clip pb-16">
          ...
          <div className="section-card grid h-full gap-3">
            ...
            <FloatingCard delay={0.08}>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Narrative: {memoryContext.careerNarrative}
              </p>
            </FloatingCard>
          </div>
        </ScrollSection>
            ...
            <FloatingCard>
              ...
              {isAuthed ? (
                <p className="mt-3 text-sm text-muted-foreground">
                  Connect GitHub and complete your profile to surface role-fit job matches here.
                </p>
              ) : (
                <div className="mt-3 space-y-3">
                  <p className="text-sm text-muted-foreground">
                    Create an account to unlock AI-matched opportunities tailored to your code and
                    career narrative.
                  </p>
                  <Link
                    href="/signup"
      ...
      <div className="fixed bottom-5 left-5 z-40 rounded-xl border border-border-light bg-panel/95 px-4 py-3 shadow-sm backdrop-blur-xl">
        <div className="flex items-center gap-3 text-xs text-muted-foreground">
          ...
          <span
            className={activeNarrativeSection === 'identity' ? 'font-semibold text-foreground' : ''}
          >
            <UserRound className="mr-1 inline h-3.5 w-3.5" />
            Identity
          </span>
          <span
            className={activeNarrativeSection === 'data' ? 'font-semibold text-foreground' : ''}
          >
            <Sparkles className="mr-1 inline h-3.5 w-3.5" />
            Data
          </span>
          <span
            className={activeNarrativeSection === 'analysis' ? 'font-semibold text-foreground' : ''}
          >
            <BrainCircuit className="mr-1 inline h-3.5 w-3.5" />
            Analysis
          </span>
          <span
            className={activeNarrativeSection === 'creation' ? 'font-semibold text-foreground' : ''}
          >
          ...
          <span
            className={
              activeNarrativeSection === 'opportunity' ? 'font-semibold text-foreground' : ''
            }
          >
